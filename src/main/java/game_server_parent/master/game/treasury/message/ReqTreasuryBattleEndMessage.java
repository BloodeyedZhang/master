...
/**
 * <p>Filename:ReqTreasuryBattleEndMessage.java</p>
 * <p>Description: </p>
 ...
 * 
 */
@MessageMeta(module=Modules.TREASURY, cmd=TreasuryDataPool.REQ_TREASURY_BATTLE_END)
public class ReqTreasuryBattleEndMessage extends Message {
    @Protobuf(order=1)
    private int code;
    ...
    public String toString() {
        return "ReqTreasuryBattleEndMessage [ code=" + code +  "]";
    }
}
