 ...
 * 
 */
@MessageMeta(module=Modules.SOILDER_TEAM, cmd=TeamDataPool.REQ_PLAYER_TEAM_LIST)
public class ReqPlayerTeamMessage extends Message {
    ...
    public String toString() {
        return "ReqPlayerTeamMessage [teamId=" + teamId+", soilderIds=" + soilderIds + "]";
    }
