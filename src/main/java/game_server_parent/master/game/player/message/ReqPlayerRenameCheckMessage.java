...
/**
 * <p>Filename:ReqPlayerRenameCheckMessage.java</p>
 * <p>Description: </p>
 ...
 * 
 */
@MessageMeta(module=Modules.PLAYER, cmd=PlayerDataPool.REQ_PLAYER_RENAME_CHECK)
public class ReqPlayerRenameCheckMessage extends Message {
    ...
    public String toString() {
        return "ReqPlayerRenameCheckMessage [name=" + name+ "]";
    }
