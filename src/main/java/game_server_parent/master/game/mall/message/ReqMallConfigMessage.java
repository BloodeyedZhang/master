...
/**
 * <p>Filename:ReqMallConfigMessage.java</p>
 * <p>Description: </p>
 ...
 * 
 */
@MessageMeta(module=Modules.MALL, cmd=MallDataPool.REQ_Mall_Config)
public class ReqMallConfigMessage extends Message {
    @Protobuf(order=1)
    private int id;
