...
/**
 * <p>Filename:ResKapaiRemoveMessage.java</p>
 * <p>Description: </p>
 ...
 * 
 */
@MessageMeta(module=Modules.KAPAI, cmd=KapaiDataPool.RES_KAPAI_REMOVE)
public class ResKapaiRemoveMessage extends Message {
    @Protobuf(fieldType = FieldType.OBJECT,order=1)
    private List<Kapai> kapais;
    
    public  ResKapaiRemoveMessage() {}
    
    public ResKapaiRemoveMessage(List<Kapai> kapais) {
        this.kapais = kapais;
    }
    ...
    public String toString() {
        return "ResKapaiRemoveMessage [kapais count=" + kapais.size() +  "]";
    }
}
