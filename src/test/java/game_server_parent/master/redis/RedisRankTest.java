...
public class RedisRankTest {
    ...
    public void testCrossBonusRank() {
        ...
        for (int i=1;i<N_RECORD*2;i++) {
            rankService.addRank(new CrossBonusPointsRank(i, 100+i));
        }
        */
       // rankService.addRank(new CrossBonusPointsRank(1000000001, 0, 1, "张三"));
       // rankService.addRank(new CrossBonusPointsRank(1000000002, 350, 3, "李四"));
